...
def cut(object, tool, eps):
    ...
    """
    return _occutilities.cut(getShape(object), getShape(tool), eps)
...
def intersect(object, tool, eps):
    ...
    eps: Tolerance value to be used.
    """
    return _occutilities.intersect(getShape(object), getShape(tool), eps)
...
def fragment(shapeList, eps):
    ...
    eps: Tolerance value to be used.
    """
    return _occutilities.fragment([getShape(shape) for shape in shapeList], eps)
...
def fuse(shapeList, eps):
    ...
    eps: Tolerance value to be used.
    """
    return _occutilities.fuse([getShape(shape) for shape in shapeList], eps)
